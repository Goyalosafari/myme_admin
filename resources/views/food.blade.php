...
<style>
   .select2-container--default .select2-selection--multiple {
    ...
    .select2-container--default .select2-selection--multiple .select2-selection__arrow {
        background-color: #007bff; /* arrow background color */
        border: 1px solid #0056b3; /* arrow border color */
            ...
            $(document).on('click', '.edit-food-btn', function (e) {
                ...
                $.ajax({
                   ...
                   success: function(data){console.log(data)
                    ...
                    $('#title').val(data.food.title);
                    $('#calorie').val(data.food.calorie);
                    $('#cooking_time').val(data.food.cooking_time);
                    $('#taste').val(data.food.taste);
                    $('#price').val(data.food.price);
                    $('#offer_price').val(data.food.offer_price);
                    $('#mrp').val(data.food.mrp);
                    $('#margin').val(data.food.margin);
                    $('#preferences').val(data.food.preferences);
                    $('#meal_type').val(data.food.meal_type);
                    $('#food_details').val(data.food.food_details);
                    $('#category_id').val(data.food.category_id);
                    $('#categories').val(data.selectedCategories).attr('selected', true);
                    $('#categories').select2();
                    $('#ref').val(data.food.ref);
                    $('#offer').val(data.food.offer);
                    $('#veg').val(data.food.veg);
                    
                    var Image = data.food.image;
                    var imgPath= "{{asset( 'storage/app/public' )}}"+ '/' + Image;
