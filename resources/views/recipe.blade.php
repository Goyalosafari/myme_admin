                ...
                <table class='table table-striped' id="tableRecipe">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> 
                                <span class="truncate" data-toggle="tooltip" data-placement="top" title="{{$data->description}}">
                                    {{$data->description}}
                                </span>    
                            </td>
                            <td> 
                                <span class="truncate" data-toggle="tooltip" data-placement="top" title="{{$data->ingredients}}">
                                    {{$data->ingredients}}
                                </span>
                            </td>
                            <td> 
                                <span class="truncate" data-toggle="tooltip" data-placement="top" title="{{$data->nutritional_facts}}">
                                    {{$data->nutritional_facts}}
                                </span>
                            </td>
                            <td> 
                                <span class="truncate" data-toggle="tooltip" data-placement="top" title="{{$data->utensils}}">
                                    {{$data->utensils}}
                                </span>
                            </td>
    ...
    <script>
        jQuery(document).ready(function ($) {
            $(document).on('click', '.edit-recipe-btn', function (e) {
                ...
                $.ajax({
                   url: '{{ route('recipe.edit', '__ID__') }}'.replace('__ID__', recipeId),
                   method : 'GET',
                   success: function(data){
                    ...
                    $('#recipeForm').attr('action', '{{ route('recipe.update', 0) }}'.slice(0, -1) + recipeId);
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const table = document.querySelector("#tableRecipe");
