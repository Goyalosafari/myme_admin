...
Route::post('admin/login',[LoginController::class, 'sendOtp'])->name('login');
Route::get('admin/otp',[LoginController::class, 'showOtpForm'])->name('admin.otp');
...
Route::middleware(['admin.auth', 'web', 'prevent-back-history'])->group(function(){
    ...
    Route::get('/grocery/category/{id}/edit',[GroceryCategoryController::class, 'edit'])->name('grocery_category.edit');
    ...
    Route::get('/grocery/product/{id}/edit',[GroceryProductController::class, 'edit'])->name('grocery_product.edit');
    ...
    Route::get('/coupen/{id}/edit',[CoupenController::class, 'edit'])->name('coupen.edit');
    ...
    Route::get('/timeslot/{id}/edit',[TimeslotController::class, 'edit'])->name('timeslot.edit');
    ...
    Route::get('/orderDetails/{orderBookId}', [OrderBookController::class, 'orderDetails'])->name('orderbook.details');
    Route::post('/changeOrderStatus/{OrderId}', [OrderBookController::class, 'updateOrderStatus'])->name('orderbook.status');
