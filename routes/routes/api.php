...
Route::get('/homeCategory3', [BannerApiController::class, 'CategoryThree']);
Route::get('/homeCategory4', [BannerApiController::class, 'CategoryFour']);
...
Route::post('/timeslots', [TimeslotApiController ::class, 'getTimeSlotByDate']);
