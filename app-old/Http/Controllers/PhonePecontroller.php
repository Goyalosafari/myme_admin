...
class PhonePecontroller extends Controller
{
    public function phonePe(Request $request)
    {
        ...
        $payment = Payment::create([
          ...
          'order' => $input['order'],
          'amount' => $input['amount'],
          'merchantId' => $data['merchantTransactionId'],
          'status' => 'processing'
        ]);
 ...
 //dd($response);
    ...
    Payment::where('merchantId', $input['merchantId'])
        ->update([
      ...
      /*  $payment = Payment::create([
       ...
       /*  $payment = Payment::create([
         ...
         // return redirect()->to('https://arovehic.com')->header('Refresh', '2;url=https://arovehic.com');      
